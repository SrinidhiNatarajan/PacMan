...
ghostblueI = createSprite(ghostblue.x,ghostblue.y,25,25)
ghostblueI.addImage(ghost1)
ghostblueI.lifetime = 1
ghostblueI.scale = 0.25
ghostblueI.velocityY = -3
ghostblueI.velocityX = 3

ghostredI = createSprite(ghostred.x,ghostred.y,25,25)
ghostredI.addImage(ghost2)
ghostredI.lifetime = 1
ghostredI.scale = 0.25
ghostredI.velocityY = -3
ghostredI.velocityX = 3

ghostpinkI = createSprite(ghostpink.x,ghostpink.y,25,25)
ghostpinkI.addImage(ghost3)
ghostpinkI.lifetime = 1
ghostpinkI.scale = 0.25
ghostpinkI.velocityY = -3
ghostpinkI.velocityX = 3

ghostyellowI = createSprite(ghostyellow.x,ghostyellow.y,25,25)
ghostyellowI.addImage(ghost4)
ghostyellowI.lifetime = 1
ghostyellowI.scale = 0.25
ghostyellowI.velocityY = -3
ghostyellowI.velocityX = 3

ghostblue1I = createSprite(ghostblue1.x,ghostblue1.y,25,25)
ghostblue1I.addImage(ghost1)
ghostblue1I.lifetime = 1
ghostblue1I.scale = 0.25
ghostblue1I.velocityY = -3
ghostblue1I.velocityX = 3

ghostred1I = createSprite(ghostred1.x,ghostred1,25,25)
ghostred1I.addImage(ghost2)
ghostred1I.lifetime = 1
ghostred1I.scale = 0.25
ghostred1I.velocityY = -3
ghostred1I.velocityX = 3

ghostpink1I = createSprite(ghostpink1.x,ghostpink1,25,25)
ghostpink1I.addImage(ghost3)
ghostpink1I.lifetime = 1
ghostpink1I.scale = 0.25
ghostpink1I.velocityY = -3
ghostpink1I.velocityX = 3

ghostyellow1I = createSprite(ghostyellow1.x,ghostyellow1,25,25)
ghostyellow1I.addImage(ghost4)
ghostyellow1I.lifetime = 1
ghostyellow1I.scale = 0.25
ghostyellow1I.velocityY = -3
ghostyellow1I.velocityX = 3

ghostGroupI.add(ghostblueI)
ghostGroupI.add(ghostredI)
ghostGroupI.add(ghostpinkI)
ghostGroupI.add(ghostyellowI)
ghostGroupI.add(ghostblue1I)
ghostGroupI.add(ghostred1I)
ghostGroupI.add(ghostpink1I)
ghostGroupI.add(ghostyellow1I)
...
ghostblueI.bounceOff(mazeGroup)
ghostredI.bounceOff(mazeGroup)
ghostpinkI.bounceOff(mazeGroup)
ghostyellowI.bounceOff(mazeGroup)

ghostblueI.bounceOff(edges)
ghostredI.bounceOff(edges)
ghostpinkI.bounceOff(edges)
ghostyellowI.bounceOff(edges)

ghostblue1I.bounceOff(mazeGroup)
ghostred1I.bounceOff(mazeGroup)
ghostpink1I.bounceOff(mazeGroup)
ghostyellow1I.bounceOff(mazeGroup)

ghostblue1I.bounceOff(edges)
ghostred1I.bounceOff(edges)
ghostpink1I.bounceOff(edges)
ghostyellow1I.bounceOff(edges)
...
if(ghostGroupI.isTouching(pacman))
{
  for(var i=0;i<ghostGroupI.length;i++){ 
    if(ghostGroupI[i].isTouching(pacman)){ 
      lifes = lifes-1
      ghostGroupI[i].destroy()
      console.log(lifes)
